...
```
I would like to learn how to calculate the chi-square cumulative probability based on the degrees of freedom and *C*-statistic, a la this [website](http://stattrek.com/online-calculator/chi-square.aspx)
