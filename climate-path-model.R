...
pairs(na.omit(select(oak_sod, ends_with("rs"), ends_with("ds"), hrsblw14_wet, avgtmin_wet, avgtmax_wet)),
      lower.panel = panel.cor, diag.panel = panel.hist,
...
pairs(na.omit(select(oak_sod, inf_oak_ct, tot_bay, tot_lfct, H.2005, H.2014, hrsblw14_wet, hrsblw10_wet, hrs1020_wet, avgtmax_wet, avgtmin_wet, hrs_blw10rs, avg_tmax_rs, avg_tmin_rs, hrs_abv25ds, avg_tmax_ds, avg_tmin_ds, rain_tot_v, rain_tot_2d, twi15m)),
      lower.panel = panel.cor, diag.panel = panel.hist)
...
oakplots.sub <- select(oak_sod, plotid:tot_bay, tot_lfct, candens15m, twi15m, elev_m, veght_m, hrs_14_20_rs, avg_tmax_rs, avg_tmax_ds, H.2005, J.2005, os_rich05, us_rich05, us.E.2005, us.H.2005, rain_tot_2d, rain_tot_v, rain_days_v, hrsblw14_wet, avgtmax_wet, avgtmin_wet)
