...
unique(droplevels(filter(alt_sp_dbh, year == 2003)$PlotID))
...
unique(droplevels(filter(alt_sp_dbh, year == 2004)$PlotID))
...
unique(droplevels(filter(alt_sp_dbh, year == 2005)$PlotID))
...
unique(alt_sp_2003$PlotID) %in% unique(alt_sp_45$PlotID)
...
alt_sp_2005_dead <- filter(alt_sp_2005, Dead == 1)
