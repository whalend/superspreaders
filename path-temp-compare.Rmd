...
oakplots.sub$umca_density_m2 <- oakplots.sub$tot_bay / (15*15)
oakplots.sub$umca_density_ha <- (oakplots.sub$tot_bay / (15*15))*10000
oakplots.sub$umca_density_m2.sqrt <- sqrt(oakplots.sub$umca_density_m2)
oakplots.sub$umca_density_ha.sqrt <- sqrt(oakplots.sub$umca_density_ha)
```
...
oakplots.sub$umca_density_m2.scl <- scale(oakplots.sub$umca_density_m2)
oakplots.sub$umca_density_m2.sqrt.scl <- scale(oakplots.sub$umca_density_m2.sqrt)
...
model_list1 <- list(
      ...
      avgtmax_ds <- lmer(hrs_abv25ds ~ twi15m.log + (1|plotid) + (1|sample_year), data = oakplots.sub),
...
model_list1.scl <- list(
      ...
      umca_density <- lm(tot_bay.log.scl ~ twi15m.log.scl, data = oakplots.sub),
      ...
      avgtmax_ds <- lmer(hrs_abv25ds.scl ~ twi15m.log.scl + (1|plotid) + (1|sample_year), data = oakplots.sub),
