---
title: "Appendix 2 - Fitting proposed path models"
...
I go through these steps for the path models in Fig. 7 and Fig. 8 (included here)  to produce the regression equations that are indicated by the path diagram.

#### First the model in Fig. 7
...
**Step 4:** For each element in this basis set, obtain the _**exact**_ probability, *Pk* that the pair (*Xi,Xj*) is statistically independent conditional on the variables *Z*.
