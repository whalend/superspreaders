...
pairs(na.omit(select(filter(microclimate_variables, sample_year != 2004), tot_lfct.log, avg_lfct.log, avg_hrs1422_wet_t_t1.log, hrs_abv25ds, avg_tmax_rs, avg_tmax_ds, avg_tmin_rs, avg_tmin_ds, avgtmax_wet)), 
